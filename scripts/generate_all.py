...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .hero {{ background: #111827; color: var(--white); padding: 4rem 2rem 3rem; text-align: center; position: relative; overflow: hidden; }}
  .hero::before {{ content: ""; position: absolute; inset: 0; background: url('poster.jpg') center top / 100% auto no-repeat; opacity: 0.75; z-index: 0; }}
  .hero::after {{ content: ""; position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(17,24,39,0.55) 0%, rgba(17,24,39,0.72) 100%); z-index: 1; }}
